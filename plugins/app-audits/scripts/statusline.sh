#!/usr/bin/env bash
# app-audits statusline — shows last main-branch CI status for the cwd's repo
#
...
CACHE_TTL="${APP_AUDITS_STATUSLINE_CACHE_TTL:-30}"   # seconds; tune via env
CACHE_DIR="${TMPDIR:-/tmp}/app-audits-statusline"
