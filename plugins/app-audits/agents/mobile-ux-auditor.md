...
**Your audit label:** `audit:mobile-ux` (applied to every issue you file — see `app-audits:filing-github-issues` for the auto-create snippet)
...
Use the `app-audits:filing-github-issues` skill for filing conventions.
