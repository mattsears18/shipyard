...
| `investigate`           | [`issue-worker/investigate.md`](./issue-worker/investigate.md)                       | `shipyard:investigate-worker` (sonnet)   | Work an untriaged / Sentry-authored issue end-to-end: investigate → rewrite → disposition (fix / needs-human / auto-close noise / dup). |
