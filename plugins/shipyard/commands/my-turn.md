...
- **Issue with `needs-refinement` label** and no `<!-- do-work-refinement-agent -->` sentinel in any comment — `/shipyard:refine-feedback` hasn't run yet OR ran and got blocked; the user may need to nudge it.
