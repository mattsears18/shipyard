...
Operator denied (#746): <O_denied> — <kind> <target> <handed back (agent-console) | shipped after one accuracy re-attempt | class stopped — <K> production-class item(s) handed back (#1563)>, ...
  Denial text: <verbatim first line of the harness denial>
  Remedy: allow <rule> via /permissions   (production-class denials only — #1563)
